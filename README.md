...
| `io.safe.staking-ui-config` | Per-chain operator config for a Safenet Beta staking UI (chain metadata, validator list, reward Merkle pointers, feature flags). Contract addresses live in a paired `io.denna.defi.address-registry` file. |
